$('.checkbox label').html(`<input id="stealth" type="checkbox" value=""><img id="as13" src="/sico/z1dms5ljhv10.png" width="70%" style="">`)

$( "a.label.label-primary.fl > img.fl" ).replaceWith('<img src="/sico/z1dmr9lrbq10.gif" class="fl" style="margin-Right: 2px; width: 70px;">');
...
<marquee direction="right" width="65%" direction="right" style="margin-bottom: -7px;font-family: 'Changa', sans-serif; height: 20px;color:#FFF7AB;" onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="0" scrollamount="5">🌸مرحبا بكم نتمنى لكم قضاء أجمل الاوقات
</marquee></font></b></td>
